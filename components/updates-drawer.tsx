...
const updates = [
  {
    date: "2025-01-24",
    changes: [
      "Added live time display with animated gradient text",
      "Implemented guided tour for new users",
      "Created a popup notification for generated absentees list",
      "Updated the layout for better responsiveness",
